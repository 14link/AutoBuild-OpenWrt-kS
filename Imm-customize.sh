...
sed -i 's/192.168.1.1/192.168.0.251/g' openwrt/package/base-files/files/bin/config_generate
...
sed -i "s/hostname='OpenWrt'/hostname='OpenWrt-imm'/g" openwrt/package/base-files/files/bin/config_generate
#
